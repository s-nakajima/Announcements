...
<div
	...
	ng-init='setInit(<?php echo $frameId; ?>,<?php echo $blockId; ?>,<?php echo $langId; ?>)'
>
	...
	<?php
	echo $this->element('setting/preview');
	?>

	<div class='draft hidden' id='nc-announcement-content-draft-<?php echo $frameId; ?>'>
		<?php if  (isset($item['Announcement']['content'])) {
			echo $item['Announcement']['content'];
		}
		?>
	...
	<!-- 編集枠  -->
	<div id='nc-announcements-form-<?php echo $frameId;?>'
	...
	>
		...
		<div class='html-editor' ng-show='View.edit.html'>
			<ul class='nav nav-tabs' role='tablist'>
				<li>
					<span class='btn btn-default' ng-click='openTextEditor(<?php echo $frameId;?>)'
						><?php echo __('HTML'); ?></span></li>
			</ul>
			<textarea
				id='nc-announcements-html-editor-<?php echo $frameId;?>'
			...
			<ul class='nav nav-tabs' role='tablist'>
				<li class='active'>
					<span class='btn btn-default'
					      ng-click='closeTextEditor(<?php echo $frameId;?>)'
						><?php echo __('HTML'); ?></span></li>
			</ul>
			<textarea
				class='form-control'
	...
	<div id='nc-announcements-block-setting-<?php echo $frameId;?>'></div>
