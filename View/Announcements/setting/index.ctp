<div
	id='nc-announcements-<?php echo (int) $frameId;?>'
	ng-controller='Announcements.edit'
	ng-init='setInit(<?php echo $frameId; ?>,<?php echo (int) $blockId; ?>,<?php echo (int) $langId; ?>)'
>
	<?php echo $this->element('setting/top_menu'); ?>

	<p>
	<div class='alert alert-danger hidden' id='nc-announcements-mss-<?php echo (int) $frameId; ?>'>
		<span class='pull-right' ng-click='postAlertClose(<?php echo (int) $frameId; ?>)'><span class='glyphicon glyphicon-remove'> </span></span></span>
