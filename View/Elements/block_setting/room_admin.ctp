			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="tab-content">
						<div class="tab-pane
							<?php if ($publishRoomAdminOnly) {
								echo 'active'; } ?>" id="nc-announcements-block-setting-parts-editor-<?php echo (int)$frameId; ?>"><?php
						...
						<div class="tab-pane" id="nc-announcements-block-setting-request-<?php
							echo (int)$frameId; ?>">
